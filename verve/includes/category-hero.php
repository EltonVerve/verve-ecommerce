...
$categoryEdits = [
    ...
    'sports' => ['THE VERVE OUTDOOR EDIT', 'Find your', 'next outside.', 'A little fresh air. A new favourite trail. Gear for the everyday adventures that make you feel alive.', 'Less routine. More adventure.', 'A hiker following a winding trail through sunlit green hills'],
...
$edit = $categoryEdits[$activeCategory['slug']] ?? ['THE VERVE COLLECTION', 'Discover your', 'next favourite.', $activeCategory['description'] ?: 'Thoughtful finds for your everyday.', 'Everyday things, thoughtfully chosen.', $activeCategory['name']];
